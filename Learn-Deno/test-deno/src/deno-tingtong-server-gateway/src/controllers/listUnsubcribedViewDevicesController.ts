...
const TAG = "getUnsubscribed";

export const getUnsubscribedListViewDevices: TListViewDevicesMiddleware =
  async (
    context,
  ) => {
    ...
    const listAllDeviceUnsubscribed = listAllDevice.players.filter((
    ...
    const res: TRes = {
      ...
      data: {
        ...
        list_unsubscribed: listAllDeviceUnsubscribed,
      },
    };
