class Authy {
  public static keyComponents = {
    keyAuth: 'new UiSelector().resourceId("com.authy.authy:id/txtTokenOtp")'
  }
}

class Github {
   public static loginComponent = {
     btnLogin: 'new UiSelector().resourceId("com.github.android:id/login_button")',
    ...
    public static homeComponent = {
     profileName: 'new UiSelector().resourceId("com.github.android:id/profile")',
     home: 'new UiSelector().resourceId("com.github.android:id/home")',
     ...
     organizationRepo: 'new UiSelector().resourceId("com.github.android:id/container")',
     listRepo: 'new UiSelector().resourceId("com.github.android:id/repo_name")',
     back: '//android.widget.ImageButton[@content-desc="Back"]',
     settings: 'new UiSelector().resourceId("com.github.android:id/settings")',
     ...
     popUpSignOut: 'new UiSelector().resourceId("android:id/button1")'
   }
 }
 ...
 class Tabular {
  public static loginComponent = {
    ...
    account: "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.support.v7.widget.RecyclerView/android.widget.LinearLayout[3]/android.widget.LinearLayout",
  };
  public static homeComponent = {
    file: "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[1]/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[1]/android.view.ViewGroup",
    titleTable: "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup/android.widget.HorizontalScrollView[2]/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[1]/android.view.ViewGroup/android.view.ViewGroup",
    test: 'new UiSelector().className("android.widget.TextView")'
  }
 }

 export { Authy, Github, Tabular };