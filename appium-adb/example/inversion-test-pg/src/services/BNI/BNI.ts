...
class BNI {
    ...
    async logIn({ device, transAccData, appiumClient }) {
        ...
        let loginBtn = await appiumClient.$$(locator.LOGIN_PAGE.LOGIN_BTN)[1]
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInTransferPage({ appiumClient, retry = 2, interval = 1000 }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInAntarBNIPage({ appiumClient, retry = 2, interval = 1000 }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInValidationPage({ appiumClient, retry = 2, interval = 1000 }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInStatusPage({ appiumClient, retry = 2, interval = 1000 }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkTransactionSuccess({ appiumClient, retry = 2, interval = 1000 }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInRekeningkuPage({ appiumClient, retry = 2, interval = 1000 }) {
