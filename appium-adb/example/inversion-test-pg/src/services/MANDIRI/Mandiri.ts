...
// import { accNoTools } from "../../configs/AccNo.js";
/**
...
class Mandiri {
    ...
    async openInternalTransfer({ _device, transAccData, appiumClient }) {
        ...
        //click transfer icon
        await (await appiumClient.$$(locator.DASHBOARD_PAGE.ACTION_ICONS)[0]).click() 
     ...
     * @param {{device: Device, transAccData: TransAccData, appiumClient: Browser}}  
     */
    async getBalance({ device, transAccData, appiumClient }) {
     ...
     * @param {{device: Device, transAccData: TransAccData, appiumClient: Browser}}  
     */
    async logOut({ _device, transAccData, appiumClient }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async hasLoggedOutPopup({ appiumClient, retry = 2, interval = 1000 }){
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsWrongPass({ appiumClient, retry = 2, interval = 1000 }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInTransPage({ appiumClient, retry = 2, interval = 1000 }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInPenerimaBaruPage({ appiumClient, retry = 2, interval = 1000 }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkErrorInputAccField({ appiumClient, retry = 2, interval = 1000 }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkAccountShown({ appiumClient, retry = 2, interval = 1000 }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInInputAmtPage({ appiumClient, retry = 2, interval = 1000 }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkErrorInputAmountField({ appiumClient, retry = 2, interval = 1000 }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsWrongPin({ appiumClient, retry = 2, interval = 1000 }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInSuccessPage({ appiumClient, retry = 2, interval = 1000 }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInTabunganPage({ appiumClient, retry = 2, interval = 1000 }) {
