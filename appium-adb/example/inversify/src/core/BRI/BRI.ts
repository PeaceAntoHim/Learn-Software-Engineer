...
class BRI {
     ...
     * @param {{device: TDevice, transAccData: TTransAccData, appiumClient: Browser}}  
     */
    async handleDashboardPopUp({ device, transAccData, appiumClient }: { device: TDevice; transAccData: TTransAccData; appiumClient: Browser; }) {
    ...
    async doubleConfirm({ device, transAccData, appiumClient }: {device: TDevice, transAccData: TTransAccData; appiumClient: Browser; }) {
        ...
        let amount = await (await appiumClient.$$(locator.CONFIRM_PAGE.VALUE_FIELD)[0] as WebdriverIO.Element).getText()
    ...
    async getBankFee({ transAccData, appiumClient }: { transAccData: TTransAccData; appiumClient: Browser; }) { 
        let feeStr = await (await appiumClient.$$(locator.CONFIRM_PAGE.VALUE_FIELD)[1] as WebdriverIO.Element).getText()
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInFormTransferAliasPage({ appiumClient, retry = 2, interval = 1000 }: { appiumClient: Browser; retry?: number; interval?: number; }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInTambahTransferAliasPage({ appiumClient, retry = 2, interval = 1000 }: { appiumClient: Browser; retry?: number; interval?: number; }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInInquiryGeneralPage({ appiumClient, retry = 2, interval = 1000 }: { appiumClient: Browser; retry?: number; interval?: number; }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsBalanceNotEnough({ appiumClient, retry = 2, interval = 1000 }: { appiumClient: Browser; retry?: number; interval?: number; }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInReceiptPage({ appiumClient, retry = 2, interval = 1000 }: { appiumClient: Browser; retry?: number; interval?: number; }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInAccountPage({ appiumClient, retry = 2, interval = 1000 }: { appiumClient: Browser; retry?: number; interval?: number; }) {
