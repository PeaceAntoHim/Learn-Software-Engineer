...
// /**
//  * @typedef {import("../../libs/TypeDef").TransAccData} TransAcc
//  * 
//  Data
...
class BCA {
    ...
    async processTransferReq({ device, transAccData, server }: { device: TDevice; transAccData: TTransAccData; server: TAppiumServer; }) {
        msgLogger.debug({ msg: `Process ${transAccData.BankCode} in ${device}`, transAccData, server })
     ...
     * @param {{device: TDevice, transAccData: TTransAccData, appiumClient: Browser}}  
     */
    async deleteInternalBeneficiary({ device, transAccData, appiumClient }: { device: TDevice; transAccData: TTransAccData; appiumClient: Browser; }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkKodeAksesShown({ appiumClient, retry = 2, interval = 1000 }: { appiumClient: Browser; retry: number; interval: number; }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInMTransferPage({ appiumClient, retry = 2, interval = 1000 }: { appiumClient: Browser; retry?: number; interval?: number; }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInRegisterNameResultPage({ appiumClient, retry = 2, interval = 1000 }: { appiumClient: Browser; retry?: number; interval?: number; }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkNameRegistedSuccess({ appiumClient, retry = 2, interval = 1000 }: { appiumClient: Browser; retry?: number; interval?: number; }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInInputTransInfoPage({ appiumClient, retry = 2, interval = 1000 }: { appiumClient: Browser; retry?: number; interval?: number; }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInConfirmPage({ appiumClient, retry = 2, interval = 1000 }: { appiumClient: Browser; retry?: number; interval?: number; }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIsInMInfoPage({ appiumClient, retry = 2, interval = 1000 }: { appiumClient: Browser; retry?: number; interval?: number; }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkTransferSuccess({ appiumClient, retry = 2, interval = 1000 }: { appiumClient: Browser; retry?: number; interval?: number; }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkIndicatorIsGreen({ appiumClient, retry = 2, interval = 1000 }: { appiumClient: Browser; retry?: number; interval?: number; }) {
     ...
     * @param {{appiumClient: Browser, retry: Number, interval: Number}}  
     */
    async checkHasAccToBeDeleted({ appiumClient, retry = 2, interval = 1000 }: { appiumClient: Browser; retry?: number; interval?: number; }) {
     ...
     */
    async hasDialogMsg({ appiumClient, defMsg= "", retry = 2, interval = 1000 }: { appiumClient: Browser; defMsg?: string; retry?: number; interval?: number; }) {
